...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support](https://tg://settings)",
                                     disable_web_page_preview=True)
            return
    ...
    if "aboutbot" in cb_data:
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
					[
						InlineKeyboardButton("🔅 Sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://tg://settings")
					],
					[
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
						InlineKeyboardButton("🔆 Sᴜᴘᴘᴏʀᴛ 🔆", url="https://tg://settings"),
						InlineKeyboardButton("🔅 Cʜᴀɴɴᴇʟ 🔅", url="https://tg://settings"),
						InlineKeyboardButton("👥 Aʙᴏᴜᴛ ", callback_data="aboutbot")
                                        ],
                                        [
						InlineKeyboardButton("👨‍🔧 Dᴇᴠs ", callback_data="aboutdevs"),
						InlineKeyboardButton("💢 Sᴏᴜʀᴄᴇ ", url="https://GitHub.com"),
						InlineKeyboardButton("🚸 Pᴏᴡᴇʀᴇᴅ ʙʏ", url="https://t.me/")
					],
                                        [
						InlineKeyboardButton("🔐 Cʟᴏsᴇ ", callback_data="closeMessage") 
					]
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/im_k8ng).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/Im_k8ng).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("🔅 Sᴜᴘᴘᴏʀᴛ", url="https://tg://settings"),
						InlineKeyboardButton("🔆 Cʜᴀɴɴᴇʟ", url="https://tg://settings/devices")
					],
					[
